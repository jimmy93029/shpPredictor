...
def main():
    inputs = {
        ...
        "sam_checkpoint_path": "C:\\coding\\python\\Predicting_mask_for_tifimage(on_local)\\Predicting_mask_for_tifimage(on_local)\\resources\\sam_vit_h_4b8939.pth",
        "device": 'cuda' if torch.cuda.is_available() else "cpu",
        "confidence_threshold": 0.35,
        "sam_encoder_version": "vit_h",
        "source_tiffile": "C:\\coding\\python\\Predicting_mask_for_tifimage(on_local)\\Predicting_mask_for_tifimage(on_local)\\resources\\NanShang_Tomb_cp.tif",
        "tile_size": 700,
